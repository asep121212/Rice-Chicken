            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('discounts.store') }}" method="POST">
                        @csrf
                        <div class="mb-3 row">
                            <label for="discount_name" class="col-sm-4 col-form-label">Nama discount <span
                        ...
                        <div class="mb-3 row">
                            <label for="discount" class="col-sm-4 col-form-label">Besaran discount <span
                                    class="required-asterisk">*</span>
                            </label>
                        ...
                        <button type="submit" class="btn btn-primary">Tambah discount</button>
                    </form>
                </div>
            </div>
        </div>
