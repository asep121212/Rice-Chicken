        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('pemasukans.update', $pemasukan->id) }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="product_id" class="col-sm-4 col-form-label">Produk <span
                    ...
                    <div class="mb-3 row">
                        <label for="tunai" class="col-sm-4 col-form-label">Tunai <span
                                class="required-asterisk">*</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="mb-3 row">
                        <label for="qr" class="col-sm-4 col-form-label">QR <span
                                class="required-asterisk">*</span></label>
                        <div class="col-sm-8">
