...
@section('title', 'Dashboard - Edit Laporan')

@section('content')
  <h1 class="h3 mb-4 text-gray-800">Update Laporan </h1>

  <div class="row">
    <div class="col-lg-6">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Form update Laporan</h6>
        </div>
        <div class="card-body">
          <form action="{{ route('laporans.update', $laporan->id) }}" method="POST">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="laporan_menu" name="laporan_menu"
                  value="{{ old('laporan_menu', $laporan->laporan_menu) }}" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="laporan_menu" class="col-sm-4 col-form-label">Menu</label>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="laporan_qr" name="laporan_qr"
                  value="{{ old('laporan_qr', $laporan->laporan_qr) }}" required>
              </div>
            </div>
            <div class="mb-3 row">
