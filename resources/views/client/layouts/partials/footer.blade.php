    ...
    <div class="container credit text-center">
      <div class="row">
        <div class="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-start align-items-center">
          <a href="https://www.tiktok.com/@rajanasikulit?_t=8pUVohdgJ06&_r=1" class="social-icons"><i class="bi bi-tiktok"></i>Raja Nasi Kulit</a>
        </div>
        <div class="col-12 col-lg-4 text-lg-start">
        <a href="https://www.facebook.com" class="social-icons"><i class="bi bi-facebook"></i>Raja Nasi Kulit</a>
        </div>
        <div class="col-12 col-lg-4 text-lg-start">
        <a href="https://www.instagram.com/raja.nasikulit?igsh=MWg1aGRoaGc2bmFoeA==" class="social-icons"><i class="bi bi-instagram"></i>Raja Nasi Kulit</a>
        </div>
      </div>
    </div>
  </footer>
