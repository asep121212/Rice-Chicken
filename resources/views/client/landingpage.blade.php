        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-center align-items-start">
                <div class="carousel-header text-start">
                    ...
                    <h2 class="carousel-text"> Nasi Kulit</h2>
                </div>
            </div>
                ...
                <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('client/img/banner-4.jpg') }}" class="d-block w-100 carousel-image"
                                alt="Banner image">
                        </div>
        ...
        <div class="half-screen-box p-4 bg-white shadow-lg animate-slideInLeft">
            <div class="icon-section d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-4">Nikmati setiap hidangan yang kami sajikan dengan penuh cinta dan
                        bahan-bahan berkualitas terbaik.</p>
                </div>
            </div>
            <div class="icon-section d-flex align-items-center">
                ...
                <div>
                    <h3 class="fw-bold text-dark mb-2">Makanan Lezat dengan Sentuhan Tradisional</h3>
                    <p class="text-muted">Nikmati setiap hidangan yang kami sajikan dengan penuh cinta dan bahan-bahan
        ...
        <div class="half-screen-box p-4 bg-white shadow-lg animate-slideInRight">
            <div class="icon-section d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-4">Gunakan peralatan dapur berkualitas untuk pengalaman memasak yang luar
                        biasa.</p>
                </div>
            </div>
            <div class="icon-section d-flex align-items-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="card product-card shadow-sm border-0 h-100">
                    <div class="image-wrapper">
                        <img src="{{ $product->image !== 'null' ? asset('storage/products/' . $product->image) : asset('client/img/' . $product->id . '.jpg') }}"
                            class="card-img-top img-fluid product-image" alt="{{ $product->product_name }}">
                    </div>
                    <div class="card-body">
            ...
            <div class="accordion-item mb-2 border rounded-3">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        Nasi Kulit adalah hidangan khas yang menggunakan nasi sebagai bahan utama dengan berbagai
                        topping dan bumbu khas.
                    </div>
                </div>
            </div>
            <div class="accordion-item mb-2 border rounded-3">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Anda dapat memesan Nasi Kulit melalui website kami atau langsung datang ke lokasi kami. Untuk
                        pemesanan online, klik tombol "Pesan" di halaman produk.
                    </div>
                </div>
            </div>
            <div class="accordion-item mb-2 border rounded-3">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        Ya, kami menyediakan pilihan vegetarian untuk beberapa menu kami. Silakan cek menu untuk
                        detailnya atau hubungi kami untuk informasi lebih lanjut.
                    </div>
                </div>
            </div>
...
section.border-bottom {
    ...
    padding-bottom: 1rem;
    /* Adds some space between content and border */
}
...
.carousel-header {
    margin-bottom: 1rem;
    /* Space between the header and carousel */
}
