...
class PemasukanController extends Controller 
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.pemasukans.index', compact('pemasukans', 'startDate', 'endDate', 'totalTunai', 'totalQr'));
    }

    public function create()
    {
        $products = Product::all(); // Use Product model
        return view('dashboard.pemasukans.create', compact('products')); // Pass products to view
    }
    ...
    {
        $products = Product::all(); // Use Product model
        return view('dashboard.pemasukans.edit', compact('pemasukan', 'products'));
    }
